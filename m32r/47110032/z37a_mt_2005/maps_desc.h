...
#define _DECLARE_ARRAY_DESC(name, category, username, scaling, axisdesc)                                               \
	const char __attribute__((section("data_desc"))) DD##name[] =                                                      \
	    "array;" category ";" username ";" scaling ";" axisdesc

#define DECLARE_ARRAY_DESC(name, category, username, scaling, axisdesc)                                                \
	_DECLARE_ARRAY_DESC(name, category, username, scaling, axisdesc)
...
#define _DECLARE_2DMAP16_DESC(name, category, username, scaling, axisname)                                             \
	const char __attribute__((section("data_desc"))) DD##name[] =                                                      \
	    "2dmap16;" category ";" username ";" scaling ";" axisname;
...
#define _DECLARE_2DMAP8_DESC(name, category, username, scaling, axisname)                                              \
	const char __attribute__((section("data_desc"))) DD##name[] =                                                      \
	    "2dmap8;" category ";" username ";" scaling ";" axisname;
...
#define _DECLARE_3DMAP8_DESC(name, category, username, scaling, xaxisname, yaxisname)                                  \
	const char __attribute__((section("data_desc"))) DD##name[] =                                                      \
	    "3dmap8;" category ";" username ";" scaling ";" xaxisname ";" yaxisname;
...
#define _DECLARE_3DMAP16_DESC(name, category, username, scaling, xaxisname, yaxisname)                                 \
	const char __attribute__((section("data_desc"))) DD##name[] =                                                      \
	    "3dmap16;" category ";" username ";" scaling ";" xaxisname ";" yaxisname;

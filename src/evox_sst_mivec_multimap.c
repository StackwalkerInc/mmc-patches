...
#define DECLARE_MIVEC_TARGET_MAP(symbol, username)                                                                     \
	DECLARE_3DMAP8_WITH_DESC(symbol, MIVEC_RPM_AXIS_SIZE, MIVEC_LOAD_AXIS_SIZE, "SST Rcus Moded MIVEC", username,      \
	                         "ValveTimingIntake", "DXflash_mivec_target_load_axis",                                    \
	                         "DXflash_mivec_target_rpm_axis") = {TEMP_3DMAP_SRC, .xsize = MIVEC_RPM_AXIS_SIZE,         \
	                                                             .data = {0x70}}
...
#define DECLARE_MDP_LOAD_MAP(symbol, username)                                                                         \
	DECLARE_3DMAP16_WITH_DESC(symbol, MDP_LOAD_RPM_AXIS_SIZE, MDP_LOAD_MDP_AXIS_SIZE, "SST Rcus Moded MIVEC",          \
	                          username, "Loadify", "DXflash_mdp_load_mdp_axis", "DXflash_mdp_load_rpm_axis") = {       \
	    TEMP_3DMAP_SRC, .xsize = MDP_LOAD_RPM_AXIS_SIZE, .data = {0x70}}

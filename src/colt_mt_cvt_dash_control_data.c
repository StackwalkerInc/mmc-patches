...
DECLARE_3DARRAY_DESC(flash_shift_light_flash_patterns, "CVT Dash Control",
                     "Shift Light Flash Patterns (100ms per slice)", "uint8",
...
const uint16_t flash_shift_light_rpm_thresholds[SHIFT_LIGHT_STAGE_COUNT] = {
    RPM_TO_HIRESTICKS(4000), RPM_TO_HIRESTICKS(4500), RPM_TO_HIRESTICKS(5000),
    RPM_TO_HIRESTICKS(5500), RPM_TO_HIRESTICKS(6000), RPM_TO_HIRESTICKS(6250),
};
DECLARE_ARRAY_DESC(flash_shift_light_rpm_thresholds, "CVT Dash Control", "Shift Light Engine RPM Thresholds",
                   "RPMhires",
                   "<table name=\"Y\" type=\"Static Y Axis\" elements=\"6\">\n"
                   "<data>0</data>\n"
                   "<data>1</data>\n"
...
const uint8_t flash_asc_flash_pattern[DASH_FLASH_MAX_SLICE_COUNT] = {0x01, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00,
                                                                     0x01, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00};
DECLARE_ARRAY_DESC(flash_asc_flash_pattern, "CVT Dash Control", "Gear Indicator Flash Pattern on ASC", "uint8",
...
DECLARE_VALUE_DESC(flash_asc_lamp_startup_time, "CVT Dash Control", "ASC Lamp Indication on Ignition", "Time");

...
DECLARE_ARRAY_DESC(flash_mode_flags0_init, "ECU Options", "ECU Options Set #1", "blobbits",
...
DECLARE_ARRAY_DESC(flash_mode_flags1_init, "ECU Options", "ECU Options Set #2", "blobbits",
                   "\t\t<table name=\"Periphery Bit Number\" type=\"Static Y Axis\" flipy=\"true\" elements=\"16\">\n"
                   "\t\t\t<data>bit.15                                                </data>\n"
...
DECLARE_ARRAY_DESC(flash_mode_flags2_init, "ECU Options", "ECU Options Set #3", "blobbits",
                   "\t\t<table name=\"Periphery Bit Number\" type=\"Static Y Axis\" flipy=\"true\" elements=\"16\">\n"
                   "\t\t\t<data>bit.15                                       </data>\n"
                   "\t\t\t<data>bit.14                                       </data>\n"
...
DECLARE_ARRAY_DESC(flash_mode_flags3_init, "ECU Options", "ECU Options Set #4", "blobbits",
                   "\t\t<table name=\"Periphery Bit Number\" type=\"Static Y Axis\" flipy=\"true\" elements=\"16\">\n"
...
DECLARE_ARRAY_DESC(flash_mode_flags4_init, "ECU Options", "ECU Options Set #5", "blobbits",
                   "\t\t<table name=\"Periphery Bit Number\" type=\"Static Y Axis\" flipy=\"true\" elements=\"16\">\n"
                   "\t\t\t<data>bit.15</data>\n"
                   "\t\t\t<data>bit.14</data>\n"

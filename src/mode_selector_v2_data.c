...
DECLARE_VALUE_DESC(flash_reset_alt_mode_on_ignition_cycle, "Mode Selector Settings", "Reset Mode On Ignition Cycle",
                   "uint8");
...
DECLARE_VALUE_DESC(flash_tps_alt_threshold, "Mode Selector Settings", "TPS Threshold For Alt Mode", "uint16");

const uint16_t flash_init_mode_switch_delay = 25;
DECLARE_VALUE_DESC(flash_init_mode_switch_delay, "Mode Selector Settings", "Mode Switch Delay", "uint16");

const uint16_t flash_mode_change_rpm_indication[2] = {
    RPM_TO_HIRESTICKS(2500),
    RPM_TO_HIRESTICKS(5000),
};
DECLARE_ARRAY_DESC(flash_mode_change_rpm_indication, "Mode Selector Settings", "Mode Change Tachometer Position",
                   "RPMhires",

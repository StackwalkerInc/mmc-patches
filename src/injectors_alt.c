...
DECLARE_ARRAY_DESC(flash_new_injector_scaling_u16a, "Injectors", "Injector Scaling - Main/Alt", "InjectorScaling1",
...
DECLARE_2DMAP8_WITH_DESC(flash_injector_latency_vs_power_2dmap8_alt, INJECTOR_POWER_AXIS_SIZE, "Injectors",
                         "Injector Latency v Battery Voltage - Alt", "InjectorLatency",
                         "DXflash_injector_latency_power_axis") = {TEMP_2DMAP_SRC, .data = {}};
...
const void *const flash_injector_latency_vs_power_2dmultimap8[8] = {
    &flash_injector_latency_vs_power_2dmap8, &flash_injector_latency_vs_power_2dmap8_alt,
    &flash_injector_latency_vs_power_2dmap8, &flash_injector_latency_vs_power_2dmap8,
    &flash_injector_latency_vs_power_2dmap8, &flash_injector_latency_vs_power_2dmap8,
    &flash_injector_latency_vs_power_2dmap8, &flash_injector_latency_vs_power_2dmap8,
};
